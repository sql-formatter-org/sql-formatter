...
export default function behavesLikeSqlFormatter(language) {
  ...
  it('formats long double parenthesized queries to multiple lines', function() {
  ...
  it('formats short double parenthesized queries to one line', function() {
